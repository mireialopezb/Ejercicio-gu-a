...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
                ...
                {
                    //Quiere saber si su nombre es palíndromo
                ...
                { 
                    //Quiere convertir su nombre a mayúsculas
        ...
        private void conectar_button_Click(object sender, EventArgs e)
        {
            ...
            IPAddress direc = IPAddress.Parse("192.168.1.46");
        ...
        private void Cont_Button_Click(object sender, EventArgs e)
        {
            ...
            byte[] msg2 = new byte[80];
            server.Receive(msg2);
            contador = Encoding.ASCII.GetString(msg2).Split('\0')[0];
